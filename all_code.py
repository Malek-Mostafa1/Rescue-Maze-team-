...
def turn(ser, direction):
    with movement_lock:
        # print(f"[TURN] Turning {direction.upper()}")
        ...
        # print(f"[TURN] Start yaw: {current_yaw:.1f}° | Target: {target_yaw:.1f}°")
...
class MotorController:
    ...
    def read_floor_sensor(self):
        # Placeholder: replace with actual floor sensor reading
        return ""
...
class DFSMazeExplorer:
    ...
    def check_tile_color(self):
        """Read floor color sensor, returns 'blue', 'red', 'black', 'white', 'silver', or None"""
    ...
    def get_unvisited_neighbors(self):
        ...
        for direction in Direction:
            ...
            # Check if neighbor is black (unreachable)
    ...
    def get_next_neighbor(self, unvisited):
        ...
        # Prefer going straight, then right, then left, then back
        priority_order = [
    ...
    def exploration_step(self):
        ...
        # Ensure heading is Direction enum
        ...
        if unvisited_neighbors:
            ...
            if self.move_to(next_x, next_y, next_dir):
                ...
                # Movement failed, pop from stack
                self.stack.pop()
...
if __name__ == "__main__":
    ...
    try:
        ...
        explorer = DFSMazeExplorer(width=20, height=20, start_x=0, start_y=0)
