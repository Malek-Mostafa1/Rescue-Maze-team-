...
if __name__ == "__main__":
    ...
    try:
        # x  =  check_directions(scan, threshold_cm=30)
        
        # front =  x["front"] , right = x["right"] , left = x["left"] , back = x["back"]
        # while not front :
        ...
        # # Turn left and move another tile
...
#             (self.laser, self.scan, self.arduino)move_one_tile
